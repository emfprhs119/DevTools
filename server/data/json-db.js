...
var Apps = require('./CompAppList.json')
...
/*
module.exports.setAppDefaultConfigs = function setAppDefaultConfigs(appName,defaultConfig){
    console.log('[setAppDefaultConfigs]','/'+appName+'/defaultConfig',defaultConfig);
    db.push('/'+appName+'/defaultConfig',defaultConfig);
}

module.exports.setConfigHolders = function setConfigHolders(appName,configHolders){
    console.log('[setConfigHolders]','/'+appName+'/configHolders',configHolders);
    db.push('/'+appName+'/configHolders',configHolders);
}
module.exports.getAppConfigHolders = function getAppConfigHolders(appName){
    console.log('[getAppConfigHolders]');
    return db.getData('/'+appName)['configHolders'];
}
*/
